    ...
    <div class="menu">
            ...
            <ul class = "list1">  
                <li><a href = "perfil.php">Início</a></li>
                  ...
                  <div class="busca">  
                <form id = "input">
                <input type ="text" class = "busca" name = "nome" placeholder = "Pesquise o evento" id = "busca"><button class = "pesquisa" style = "cursor:pointer;"><i class="fa fa-search"></i></button>
           </form>
            </div>
            </div>             
            <div class="menu2">
...
<div class="item2"><i class="fa fa-toggle-left"></i></div> 

<div class="pages2">                

</div>  

<div class="item2"><i class="fa fa-toggle-right"></i></div>   
