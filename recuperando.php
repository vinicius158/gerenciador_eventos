...
<head>
    ...
    <link rel = "stylesheet" href = "css/estilo_recuperando.css">          
...
<body>            
    ...
    <div class="title"><p class = "title2">Recuperação da conta</p></div>

    <form id = "form">           
        
    <input type = "email" placeholder = "Digite seu email" id = "email">                
    <input type = "email" placeholder = "Insira novamente" id = "email2">        
